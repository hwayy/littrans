...
Follow `skills/transcribe-literature-assets/SKILL.md`. Read only the assigned transcription packet and its original text/images. Use the configured host role model; Codex defaults to fresh gpt-5.6-luna at max effort. Preserve formula structure and source notation, record uncertainty and keep whole figures intact.
