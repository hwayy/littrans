...
3. Run `source prepare` for the requested PDF pages. It combines native glyph geometry with the isolated layout detector. Formulas, complex tables, code and figures become original-image assets; it does not decode formulas. Do not offer extraction-mode choices.
