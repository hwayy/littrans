...
5. Restore code indentation exactly, set `code_language`, and confirm that literal tags such as `<Button>` are inside code or remain literal prose. Mark Note/Tip/Warning blocks as `note`.
